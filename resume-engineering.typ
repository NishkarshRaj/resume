...
#resume_section(
    ...
    [
        #lines_with_date_and_description(
            ...
            [
                - Architected AI-powered cost optimization platform using AWS Bedrock (Claude) and FastAPI processing 10M+ cost events daily -- designed custom LangChain agents for anomaly detection, implemented automated remediation workflows with 95% recommendation accuracy, and built real-time alerting system -- reduced infrastructure waste by \$2M annually across multi-cloud environments
                - Led cloud infrastructure optimization across 500+ AWS resources serving 35-state regulatory compliance platform -- designed RDS right-sizing framework analyzing 6-month CloudWatch metrics, architected ARM-based Graviton migration strategy (40% performance improvement), implemented S3 Intelligent Tiering with automated lifecycle policies, and redesigned KMS architecture for batch processing (94% cost reduction) -- delivered \$5M annual savings while maintaining 99.95% uptime SLA
